    ...
    >
      <div className="relative">
        ...
        <button
          onClick={e => {
            e.stopPropagation();
            if (window.confirm('Remove this item?')) onDelete();
          }}
      ...
      <div className="p-3">
        ...
        {item.price && (
          <p className="text-lg font-bold text-indigo-600 mb-0.5">{item.price}</p>
        )}
        {lastChecked && (
          <p className="text-xs text-gray-400 mb-2">Updated {lastChecked}</p>
        )}
